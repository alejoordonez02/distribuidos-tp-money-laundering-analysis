...
class MergedTransactions(Message):
    def __init__(self, client_id: UUID, transactions: list[Transaction], averages: dict[str, float]):
    ...
    def _fields(self) -> list[Any]:
        return [
            ...
            *[[payment_format, average] for payment_format, average in self.averages.items()],
        ]
